            ...
            <div className="px-6 pb-10">
              <div className="lg:flex lg:gap-6">
                ...
                <section className="flex-1">
                  ...
                  <div className="h-[860px] bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                      </svg>
                      <h3 className="font-medium">You have <span className="text-blue-500">3 notifications</span> today.</h3>
                    </div>
                    ...
                    <div className="mt-7">
                      ...
                      <ul className="flex items-center gap-5">
                        <input className="size-6 cursor-pointer" type="checkbox" />

                        <li>
                          <NavLink to={'/notification'} className={({ isActive }) => `py-2 px-4 rounded-lg
                          ${isActive ? "bg-blue-600 hover:bg-blue-500 text-white" : "border border-neutral-300 hover:bg-neutral-100"}`}>
                            All
                          </NavLink>
                        </li>
                        <li>
                          <NavLink to={'/'} className={({ isActive }) => `py-2 px-4 rounded-lg
                        ${isActive ? "bg-blue-600 hover:bg-blue-500 text-white" : "border border-neutral-300 hover:bg-neutral-100"}`}>
                            New job
                          </NavLink>
                        </li>
